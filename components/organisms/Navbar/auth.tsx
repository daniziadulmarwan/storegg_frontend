  ...
  if(isLogin) {
    return (
      <li className="nav-item my-auto dropdown d-flex">
        ...
        <div>
            <a onClick={() => setOpen(!open)} className="dropdown-toggle ms-lg-40" href="#" role="button" id="dropdownMenuLink"
                data-bs-toggle="dropdown" aria-expanded="false">
                <img src="/img/avatar-1.png" className="rounded-circle" width="40" height="40"
                    alt="" />
            </a>

            <ul className={`dropdown-menu border-0 ${open ? 'd-block' : ''}`} aria-labelledby="dropdownMenuLink">
                <li>
                  <Link href="/member">
