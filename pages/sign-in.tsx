        ...
        <section className="sign-in mx-auto">
            <div className="row">
                            ...
                            <div className="pb-50">
                                <Link href="/">
                                    <a className="navbar-brand" href="">
                                        <Image src="/icon/signin.svg" width={60} height={60} alt="Gambar Logo" />
                                    </a>
                                </Link>
                            </div>
                            <SignInForm />
                ...
                <div className="col-xxl-7 col-lg-6 bg-blue text-center pt-lg-145 pb-lg-145 d-lg-block d-none">
                    <Image src="/img/Header-9.png" width={502} height={391.21} className="img-fluid pb-50" alt="Gambar Header" /> 
